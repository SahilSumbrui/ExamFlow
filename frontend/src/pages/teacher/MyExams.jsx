    ...
    <div className={`min-h-screen transition-colors duration-500 ${theme === 'dark' ? 'bg-[#0b0f1a]' : 'bg-slate-50'}`}>
      ...
      <div className="lg:pl-64 pt-20 md:pt-20 lg:pt-0 p-6 md:p-8 lg:pl-72 lg:pr-8">
        ...
        <header className="flex items-center justify-between mb-10">
          <div>
            <h2 className={`text-3xl font-black tracking-tight ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>My Examinations</h2>
            <p className="text-slate-500 font-medium">Manage all your assessments</p>
          </div>
          <button 
